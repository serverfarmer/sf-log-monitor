...
^\w{3} [ :0-9]{11} [._[:alnum:]-]+ kernel: \[[ .0-9]+\] Hardware name: Amazon EC2 [0-9a-z.]+/, BIOS 1\.0 10/16/2017$
^\w{3} [ :0-9]{11} [._[:alnum:]-]+ kernel: \[[ .0-9]+\] Hardware name: Xen HVM domU, BIOS 4\.2\.amazon 08/24/2006$
